...
const en = {
  ...
  "settings.widgetsHint": "Drag to reorder; tap the eye to hide a card; expand a card to toggle its readings.",
  "settings.hideWidget": "Hide {label}",
  "settings.showWidget": "Show {label}",
...
const nl: Record<MsgKey, string> = {
  ...
  "settings.widgets": "Widgets",
  "settings.widgetsHint": "Sleep om te ordenen; tik op het oog om een kaart te verbergen; klap een kaart open voor de metingen.",
  "settings.hideWidget": "{label} verbergen",
  "settings.showWidget": "{label} tonen",
